...
const NotFoundError = () => {
    ...
    return ( <div style={{minHeight:`calc(100vh - ${elHeight}px)`}}className={styles.notFound}>
        <div className={styles.pattern}><img src={pattern} alt='pattern'/></div>
        ...
        <Link to='/'><p className={styles.backLink}>Späť na úvodnú stránku</p></Link>
        <Copyright />
    </div> );
}
